...
def run(
        ...
        source=ROOT / '/home/pi/Sofia',  # file/dir/URL/glob/screen/0(webcam)
        ...
        project='/home/pi/yoloresult',  # save results to project/name
                ...
                if dataset.mode == 'image':
                    ...
                    if vid_path[i] != save_path:  # new video
                        ...
                        if vid_cap:  # video
                            ...
                            fps, w, h =1000, im0.shape[1], im0.shape[0]
